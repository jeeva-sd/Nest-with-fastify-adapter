...
export const actionMessages = {
    ...
    203: {
        message: 'Request succeeded, but details might be rough',
        status: MessageStatus.success,
    },
    ...
    301: {
        message: 'Resource has been permanently moved',
        status: MessageStatus.error,
    },
    302: {
        message: 'Resource has been temporarily moved',
        status: MessageStatus.error,
    },
    ...
    405: {
        message: 'Requested method is not supported for this endpoint',
        status: MessageStatus.error,
    },
    406: {
        message: 'Server cannot generate a response in the requested format',
        status: MessageStatus.error,
    },
    408: {
        message: 'Request timed out due to server or network delays',
        status: MessageStatus.error,
    },
    409: {
        message: 'Request conflicts with existing data or resources',
        status: MessageStatus.error,
    },
    410: {
    ...
    414: {
        message: 'Request URI exceeds the maximum permissible length',
        status: MessageStatus.error,
    },
    412: {
        message: 'One or more preconditions specified in the request failed',
        status: MessageStatus.error,
    },
    413: {
        message: 'Request payload exceeds the maximum allowable size',
        status: MessageStatus.error,
    },
    415: {
